...
-->
  ...
  <img src="https://img.shields.io/badge/-C%23-000000?logo=Csharp&style=flat&logo=Java&logoColor=white"/></a> &nbsp
  <br>
  ...
  5. **MailApp** <br>
     ...
     👩‍🏫 소개 : 아이폰의 메일 앱을 UI와 기능을 구현한 어플리케이션. 학회 후배들 교육을 위한 목적으로 구현함. <br>
               An app with a user interface similar to the iPhone's Mail app. It was developed for educational purposes
